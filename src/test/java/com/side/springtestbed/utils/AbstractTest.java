...
public abstract class AbstractTest {
    ...
    private org.ehcache.core.Ehcache getEhcache(StorageAccess storageAccess) {
        return ReflectionUtils.getFieldValue(storageAccess, "ehCache");
    }
    ...
    protected String resultSetToString(ResultSet resultSet) {
        net.steppschuh.markdowngenerator.table.Table.Builder tableBuilder = new net.steppschuh.markdowngenerator.table.Table.Builder();
